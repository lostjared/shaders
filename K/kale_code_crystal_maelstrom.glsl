...
const int STYLE = 1;
const float SEGMENTS_A = 9.0;
const float SEGMENTS_B = 14.0;
const float FOLD_ZOOM = 1.56;
const float WARP = 0.24;
...
vec3 spectralPalette(float t) {
    vec3 phase = vec3(0.08, 0.52, 0.96);
