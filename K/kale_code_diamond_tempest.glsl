...
const int STYLE = 11;
const float SEGMENTS_A = 16.0;
const float SEGMENTS_B = 6.0;
const float FOLD_ZOOM = 1.76;
const float WARP = 0.23;
...
vec3 spectralPalette(float t) {
    vec3 phase = vec3(0.34, 0.88, 0.55);
