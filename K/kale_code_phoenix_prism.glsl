...
const int STYLE = 5;
const float SEGMENTS_A = 5.0;
const float SEGMENTS_B = 15.0;
const float FOLD_ZOOM = 1.72;
const float WARP = 0.31;
...
vec3 spectralPalette(float t) {
    vec3 phase = vec3(0.96, 0.28, 0.04);
