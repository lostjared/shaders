...
const int STYLE = 6;
const float SEGMENTS_A = 10.0;
const float SEGMENTS_B = 16.0;
const float FOLD_ZOOM = 1.38;
const float WARP = 0.21;
...
vec3 spectralPalette(float t) {
    vec3 phase = vec3(0.64, 0.12, 0.82);
