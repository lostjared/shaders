...
const int STYLE = 10;
const float SEGMENTS_A = 13.0;
const float SEGMENTS_B = 9.0;
const float FOLD_ZOOM = 1.58;
const float WARP = 0.17;
...
vec3 spectralPalette(float t) {
    vec3 phase = vec3(0.84, 0.42, 0.16);
