...
const int STYLE = 9;
const float SEGMENTS_A = 8.0;
const float SEGMENTS_B = 12.0;
const float FOLD_ZOOM = 1.29;
const float WARP = 0.34;
...
vec3 spectralPalette(float t) {
    vec3 phase = vec3(0.57, 0.05, 0.73);
