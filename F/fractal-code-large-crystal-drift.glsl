...
// Transparent large-form fractal distortion: crystal drift.
const float PI = 3.14159265358979323846;
const int STYLE = 1;
const float SEGMENTS = 6.000;
const float FOLD_ZOOM = 1.160;
const float MOTION = 0.580;
const float DISTORTION = 0.024;
const float EFFECT_MIX = 0.520;
const vec3 TINT_A = vec3(0.860, 1.040, 1.160);
const vec3 TINT_B = vec3(1.120, 0.940, 0.840);
