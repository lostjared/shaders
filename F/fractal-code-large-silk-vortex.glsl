...
// Transparent large-form fractal distortion: silk vortex.
const float PI = 3.14159265358979323846;
const int STYLE = 2;
const float SEGMENTS = 8.000;
const float FOLD_ZOOM = 1.080;
const float MOTION = 0.420;
const float DISTORTION = 0.019;
const float EFFECT_MIX = 0.490;
const vec3 TINT_A = vec3(0.900, 1.040, 1.120);
const vec3 TINT_B = vec3(1.100, 0.920, 1.080);
