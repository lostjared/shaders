...
// Transparent large-form fractal distortion: liquid cathedral.
const float PI = 3.14159265358979323846;
const int STYLE = 4;
const float SEGMENTS = 12.000;
const float FOLD_ZOOM = 1.100;
const float MOTION = 0.720;
const float DISTORTION = 0.027;
const float EFFECT_MIX = 0.580;
const vec3 TINT_A = vec3(0.860, 1.080, 1.120);
const vec3 TINT_B = vec3(1.120, 0.900, 1.040);
