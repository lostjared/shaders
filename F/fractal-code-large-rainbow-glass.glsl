...
// Transparent large-form fractal distortion: rainbow glass.
const float PI = 3.14159265358979323846;
const int STYLE = 4;
const float SEGMENTS = 6.000;
const float FOLD_ZOOM = 1.180;
const float MOTION = 0.740;
const float DISTORTION = 0.029;
const float EFFECT_MIX = 0.600;
const vec3 TINT_A = vec3(1.140, 0.900, 1.040);
const vec3 TINT_B = vec3(0.840, 1.100, 1.140);
