...
// Transparent large-form fractal distortion: chromatic mist.
const float PI = 3.14159265358979323846;
const int STYLE = 1;
const float SEGMENTS = 7.000;
const float FOLD_ZOOM = 1.140;
const float MOTION = 0.880;
const float DISTORTION = 0.021;
const float EFFECT_MIX = 0.520;
const vec3 TINT_A = vec3(1.120, 0.880, 1.080);
const vec3 TINT_B = vec3(0.880, 1.100, 1.100);
