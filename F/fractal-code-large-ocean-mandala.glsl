...
// Transparent large-form fractal distortion: ocean mandala.
const float PI = 3.14159265358979323846;
const int STYLE = 3;
const float SEGMENTS = 10.000;
const float FOLD_ZOOM = 1.130;
const float MOTION = 0.620;
const float DISTORTION = 0.025;
const float EFFECT_MIX = 0.560;
const vec3 TINT_A = vec3(0.840, 1.080, 1.140);
