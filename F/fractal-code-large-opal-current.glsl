...
// Transparent large-form fractal distortion: opal current.
const float PI = 3.14159265358979323846;
const int STYLE = 2;
const float SEGMENTS = 5.000;
const float FOLD_ZOOM = 1.100;
const float MOTION = 0.840;
const float DISTORTION = 0.022;
const float EFFECT_MIX = 0.510;
const vec3 TINT_A = vec3(1.100, 0.920, 1.120);
const vec3 TINT_B = vec3(0.820, 1.100, 1.040);
