...
// Transparent large-form fractal distortion: mercury fold.
const float PI = 3.14159265358979323846;
const int STYLE = 0;
const float SEGMENTS = 6.000;
const float FOLD_ZOOM = 1.220;
const float MOTION = 0.360;
const float DISTORTION = 0.021;
const float EFFECT_MIX = 0.500;
const vec3 TINT_A = vec3(0.960, 1.040, 1.080);
const vec3 TINT_B = vec3(1.080, 0.960, 0.900);
