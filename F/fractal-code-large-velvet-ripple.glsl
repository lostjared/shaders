...
// Transparent large-form fractal distortion: velvet ripple.
const float PI = 3.14159265358979323846;
const int STYLE = 1;
const float SEGMENTS = 5.000;
const float FOLD_ZOOM = 1.090;
const float MOTION = 0.920;
const float DISTORTION = 0.017;
const float EFFECT_MIX = 0.470;
const vec3 TINT_A = vec3(1.080, 0.880, 1.060);
const vec3 TINT_B = vec3(0.900, 1.060, 1.100);
