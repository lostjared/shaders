...
// Transparent large-form fractal distortion: solar petal.
const float PI = 3.14159265358979323846;
const int STYLE = 0;
const float SEGMENTS = 5.000;
const float FOLD_ZOOM = 1.190;
const float MOTION = 0.520;
const float DISTORTION = 0.020;
const float EFFECT_MIX = 0.500;
const vec3 TINT_A = vec3(1.140, 1.020, 0.840);
const vec3 TINT_B = vec3(0.920, 0.960, 1.120);
