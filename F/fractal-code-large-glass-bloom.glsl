...
// Transparent large-form fractal distortion: glass bloom.
const float PI = 3.14159265358979323846;
const int STYLE = 4;
const float SEGMENTS = 5.000;
const float FOLD_ZOOM = 1.200;
const float MOTION = 0.540;
const float DISTORTION = 0.028;
const float EFFECT_MIX = 0.570;
const vec3 TINT_A = vec3(1.080, 1.020, 0.880);
const vec3 TINT_B = vec3(0.880, 1.040, 1.140);
