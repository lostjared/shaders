...
// Transparent large-form fractal distortion: prism tide.
const float PI = 3.14159265358979323846;
const int STYLE = 4;
const float SEGMENTS = 7.000;
const float FOLD_ZOOM = 1.140;
const float MOTION = 0.680;
const float DISTORTION = 0.026;
const float EFFECT_MIX = 0.550;
const vec3 TINT_A = vec3(1.120, 0.900, 1.060);
const vec3 TINT_B = vec3(0.860, 1.080, 1.140);
