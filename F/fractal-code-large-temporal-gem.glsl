...
// Transparent large-form fractal distortion: temporal gem.
const float PI = 3.14159265358979323846;
const int STYLE = 1;
const float SEGMENTS = 10.000;
const float FOLD_ZOOM = 1.150;
const float MOTION = 0.960;
const float DISTORTION = 0.025;
const float EFFECT_MIX = 0.560;
const vec3 TINT_A = vec3(0.900, 1.100, 1.060);
const vec3 TINT_B = vec3(1.120, 0.880, 1.100);
