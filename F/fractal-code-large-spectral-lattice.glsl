...
// Transparent large-form fractal distortion: spectral lattice.
const float PI = 3.14159265358979323846;
const int STYLE = 3;
const float SEGMENTS = 8.000;
const float FOLD_ZOOM = 1.160;
const float MOTION = 0.820;
const float DISTORTION = 0.026;
const float EFFECT_MIX = 0.570;
const vec3 TINT_A = vec3(1.100, 0.900, 1.120);
const vec3 TINT_B = vec3(0.860, 1.120, 0.940);
