...
// Transparent large-form fractal distortion: pearl tunnel.
const float PI = 3.14159265358979323846;
const int STYLE = 0;
const float SEGMENTS = 9.000;
const float FOLD_ZOOM = 1.070;
const float MOTION = 0.640;
const float DISTORTION = 0.019;
const float EFFECT_MIX = 0.490;
const vec3 TINT_A = vec3(1.080, 1.020, 0.940);
const vec3 TINT_B = vec3(0.920, 1.040, 1.120);
