...
// Transparent large-form fractal distortion: diamond breeze.
const float PI = 3.14159265358979323846;
const int STYLE = 3;
const float SEGMENTS = 4.000;
const float FOLD_ZOOM = 1.180;
const float MOTION = 0.480;
const float DISTORTION = 0.018;
const float EFFECT_MIX = 0.480;
const vec3 TINT_A = vec3(0.960, 1.080, 1.140);
const vec3 TINT_B = vec3(1.120, 0.900, 0.960);
