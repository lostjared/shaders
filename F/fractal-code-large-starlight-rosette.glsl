...
// Transparent large-form fractal distortion: starlight rosette.
const float PI = 3.14159265358979323846;
const int STYLE = 3;
const float SEGMENTS = 14.000;
const float FOLD_ZOOM = 1.090;
const float MOTION = 0.680;
const float DISTORTION = 0.024;
const float EFFECT_MIX = 0.550;
const vec3 TINT_A = vec3(1.120, 1.040, 0.880);
const vec3 TINT_B = vec3(0.900, 0.940, 1.140);
