...
// Transparent large-form fractal distortion: nebula lens.
const float PI = 3.14159265358979323846;
const int STYLE = 1;
const float SEGMENTS = 9.000;
const float FOLD_ZOOM = 1.110;
const float MOTION = 0.760;
const float DISTORTION = 0.023;
const float EFFECT_MIX = 0.530;
const vec3 TINT_A = vec3(0.920, 0.880, 1.160);
const vec3 TINT_B = vec3(1.080, 1.060, 0.900);
