...
// Transparent large-form fractal distortion: hologram cascade.
const float PI = 3.14159265358979323846;
const int STYLE = 4;
const float SEGMENTS = 8.000;
const float FOLD_ZOOM = 1.150;
const float MOTION = 0.780;
const float DISTORTION = 0.030;
const float EFFECT_MIX = 0.590;
const vec3 TINT_A = vec3(1.100, 0.920, 1.140);
const vec3 TINT_B = vec3(0.840, 1.100, 0.980);
