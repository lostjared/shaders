...
// Transparent large-form fractal distortion: cosmic embroidery.
const float PI = 3.14159265358979323846;
const int STYLE = 2;
const float SEGMENTS = 11.000;
const float FOLD_ZOOM = 1.130;
const float MOTION = 0.460;
const float DISTORTION = 0.022;
const float EFFECT_MIX = 0.510;
const vec3 TINT_A = vec3(0.940, 0.880, 1.140);
const vec3 TINT_B = vec3(1.120, 1.040, 0.880);
