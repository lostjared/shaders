...
// Transparent large-form fractal distortion: quartz orbit.
const float PI = 3.14159265358979323846;
const int STYLE = 2;
const float SEGMENTS = 7.000;
const float FOLD_ZOOM = 1.170;
const float MOTION = 0.660;
const float DISTORTION = 0.024;
const float EFFECT_MIX = 0.530;
const vec3 TINT_A = vec3(0.940, 1.100, 1.120);
const vec3 TINT_B = vec3(1.100, 0.880, 1.000);
