...
// Transparent large-form fractal distortion: deepwater fold.
const float PI = 3.14159265358979323846;
const int STYLE = 0;
const float SEGMENTS = 7.000;
const float FOLD_ZOOM = 1.110;
const float MOTION = 0.380;
const float DISTORTION = 0.020;
const float EFFECT_MIX = 0.500;
const vec3 TINT_A = vec3(0.820, 1.040, 1.140);
const vec3 TINT_B = vec3(1.060, 0.940, 1.080);
