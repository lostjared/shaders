...
// Transparent large-form fractal distortion: aurora veil.
const float PI = 3.14159265358979323846;
const int STYLE = 0;
const float SEGMENTS = 4.000;
const float FOLD_ZOOM = 1.120;
const float MOTION = 0.720;
const float DISTORTION = 0.020;
const float EFFECT_MIX = 0.500;
const vec3 TINT_A = vec3(0.820, 1.080, 1.180);
const vec3 TINT_B = vec3(1.100, 0.860, 1.040);
