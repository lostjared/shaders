...
void main() {
    ...
    // Normalize mouse coordinates to match the 0.0 to 1.0 UV space
    vec2 mouseUV = iMouse.xy / iResolution.xy;
    
    // Set feedback center to mouse position, keeping the procedural distortion
    vec2 feedbackCenter = mouseUV + distort * 2.5;
