#version 330 core
// code-frac-x-aurora-sanctum: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: dihedral cathedral IFS. Detail engine: three-scale aurora turbulence.
out vec4 color;
in vec2 tc;
