#version 330 core
// code-frac-x-holographic-hive: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: triangular crystal lattice. Detail engine: two-scale Voronoi fracture.
out vec4 color;
in vec2 tc;
