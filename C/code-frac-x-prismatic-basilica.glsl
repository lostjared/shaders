#version 330 core
// code-frac-x-prismatic-basilica: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: dihedral cathedral IFS. Detail engine: two-scale Voronoi fracture.
out vec4 color;
in vec2 tc;
