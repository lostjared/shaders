#version 330 core
// code-frac-x-spectral-icefield: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: triangular crystal lattice. Detail engine: three-scale aurora turbulence.
out vec4 color;
in vec2 tc;
...
const float EXPOSURE = 1.092;
const float HUE_SHIFT = 0.960;
