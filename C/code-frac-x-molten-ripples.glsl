#version 330 core
// code-frac-x-molten-ripples: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: multi-octave liquid recursion. Detail engine: antialiased log-polar tunnel.
out vec4 color;
in vec2 tc;
...
const float FOLD_GAIN = 1.365;
const float SPIN_RATE = 0.261;
const float WARP_STRENGTH = 0.770;
const float TEXTURE_MIX = 0.785;
const float EXPOSURE = 1.038;
const float HUE_SHIFT = 0.386;
