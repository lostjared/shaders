#version 330 core
// code-frac-x-stained-glass-julia: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: dihedral cathedral IFS. Detail engine: smooth Julia escape field.
out vec4 color;
in vec2 tc;
