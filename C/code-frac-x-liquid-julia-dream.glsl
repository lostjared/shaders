#version 330 core
// code-frac-x-liquid-julia-dream: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: multi-octave liquid recursion. Detail engine: smooth Julia escape field.
out vec4 color;
in vec2 tc;
