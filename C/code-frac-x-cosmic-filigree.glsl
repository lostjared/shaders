#version 330 core
// code-frac-x-cosmic-filigree: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: rational Mobius inversion. Detail engine: crystal orbit traps.
out vec4 color;
in vec2 tc;
