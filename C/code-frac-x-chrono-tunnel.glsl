#version 330 core
// code-frac-x-chrono-tunnel: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: log-polar singularity recursion. Detail engine: antialiased log-polar tunnel.
out vec4 color;
in vec2 tc;
