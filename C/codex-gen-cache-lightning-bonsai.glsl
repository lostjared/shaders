#version 330 core
// Codex cache concept 011: lightning bonsai.
...
vec3 palette(float phase) {
    return 0.5 + 0.5 * cos(TAU * (phase + 0.370 + vec3(0.04, 0.37, 0.69)));
}
