#version 330 core
// code-frac-x-julia-wormhole: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: log-polar singularity recursion. Detail engine: smooth Julia escape field.
out vec4 color;
in vec2 tc;
