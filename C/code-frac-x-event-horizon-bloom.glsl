#version 330 core
// code-frac-x-event-horizon-bloom: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: log-polar singularity recursion. Detail engine: crystal orbit traps.
out vec4 color;
in vec2 tc;
