#version 330 core
// code-frac-x-tesseract-lattice: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: triangular crystal lattice. Detail engine: antialiased log-polar tunnel.
out vec4 color;
in vec2 tc;
