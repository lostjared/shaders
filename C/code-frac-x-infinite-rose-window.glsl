#version 330 core
// code-frac-x-infinite-rose-window: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: dihedral cathedral IFS. Detail engine: antialiased log-polar tunnel.
out vec4 color;
in vec2 tc;
