#version 330 core
// code-frac-x-aurora-maelstrom: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: multi-octave liquid recursion. Detail engine: three-scale aurora turbulence.
out vec4 color;
in vec2 tc;
