#version 330 core
// ant_light_color_acid_ripple_with_spirals
// Acid-colored expanding ripples with interference, feedback distortion, and audio-reactive spirals
...
void main() {
    ...
    // ---------------------------------------------------------
    // NEW: Audio-Reactive Spiral Lighting Pass
    // ---------------------------------------------------------
