#version 330 core
// code-frac-x-diamond-supernova: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: triangular crystal lattice. Detail engine: crystal orbit traps.
out vec4 color;
in vec2 tc;
