#version 330 core
// code-frac-x-plasma-chrysalis: 4K+ derivative-filtered remix of the Acid Cam frac shader family.
// Domain engine: multi-octave liquid recursion. Detail engine: crystal orbit traps.
out vec4 color;
in vec2 tc;
