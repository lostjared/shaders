#version 330 core
// ant_peak_inversion_cache_spectrum_time_warp_drive_overload
// Hyperspace streaks where each streak's stretch is 5x its history bass
