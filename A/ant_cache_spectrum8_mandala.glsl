#version 330 core
// ant_cache_spectrum8_mandala
// Symmetric mandala with 8 history rings pulsing on different bands
...
void main() {
    ...
    for (int i = 0; i < 8; i++) {
        ...
        float rband = exp(-pow((r - 0.1 - 0.07 * float(i) - h * 0.2) * 12.0, 2.0));
        ...
        acc += (c + tint) * ring * rband * (1.0 + h * 6.0);
    }
    acc *= 1.5;
