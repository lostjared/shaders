...
layout(set = 0, binding = 3) uniform sampler1D spectrum; // live FFT (always bound when audio is enabled)
...
// 16 Temporal Buffers
layout(set = 0, binding = 3) uniform sampler1D spectrum0;  // T=0 (Now)
