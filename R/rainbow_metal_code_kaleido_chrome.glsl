...
// kaleidoscopic liquid chrome: high-detail rainbow metal with audio-reactive physical lighting.
...
const float HUE_OFFSET = 0.29;
const float WARP_STRENGTH = 1.48;
const float BASE_ROUGHNESS = 0.10;
const float MOTION_SPEED = 1.24;
