...
// radiant double helix metal: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 47.0;
const float HUE_OFFSET = 0.36;
const float WARP_STRENGTH = 1.52;
const float BASE_ROUGHNESS = 0.13;
const float MOTION_SPEED = 1.26;
