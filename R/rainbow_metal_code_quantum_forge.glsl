...
// quantized rainbow forge: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 61.0;
const float HUE_OFFSET = 0.64;
const float WARP_STRENGTH = 1.70;
const float BASE_ROUGHNESS = 0.18;
const float MOTION_SPEED = 1.52;
