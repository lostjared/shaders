...
// liquid kaleidoscope mandala: high-detail rainbow metal with audio-reactive physical lighting.
...
const int STYLE = 3;
const float ARMS = 10.0;
const float DENSITY = 39.0;
const float HUE_OFFSET = 0.58;
const float WARP_STRENGTH = 1.20;
const float BASE_ROUGHNESS = 0.20;
const float MOTION_SPEED = 0.78;
