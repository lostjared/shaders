...
// psychedelic liquid foundry: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 64.0;
const float HUE_OFFSET = 0.84;
const float WARP_STRENGTH = 1.74;
const float BASE_ROUGHNESS = 0.21;
const float MOTION_SPEED = 1.48;
