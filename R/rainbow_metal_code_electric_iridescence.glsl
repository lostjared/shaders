...
// electric iridescent ferrofluid: high-detail rainbow metal with audio-reactive physical lighting.
...
const int STYLE = 4;
const float ARMS = 22.0;
const float DENSITY = 63.0;
const float HUE_OFFSET = 0.13;
const float WARP_STRENGTH = 1.72;
const float BASE_ROUGHNESS = 0.10;
const float MOTION_SPEED = 1.46;
