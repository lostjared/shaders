...
// neon magnetic mercury: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 44.0;
const float HUE_OFFSET = 0.69;
const float WARP_STRENGTH = 1.55;
const float BASE_ROUGHNESS = 0.11;
const float MOTION_SPEED = 1.34;
