...
// hypercolor domain-warped alloy: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 57.0;
const float HUE_OFFSET = 0.25;
const float WARP_STRENGTH = 1.62;
const float BASE_ROUGHNESS = 0.20;
const float MOTION_SPEED = 1.38;
