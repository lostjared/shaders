...
// supernova magnetic metal: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 68.0;
const float HUE_OFFSET = 0.71;
const float WARP_STRENGTH = 1.80;
const float BASE_ROUGHNESS = 0.16;
const float MOTION_SPEED = 1.64;
