...
// magnetic opal field: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 37.0;
const float HUE_OFFSET = 0.41;
const float WARP_STRENGTH = 1.38;
const float BASE_ROUGHNESS = 0.21;
const float MOTION_SPEED = 0.88;
