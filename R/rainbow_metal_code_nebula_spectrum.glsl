...
// nebular spectrum alloy: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 45.0;
const float HUE_OFFSET = 0.87;
const float WARP_STRENGTH = 1.58;
const float BASE_ROUGHNESS = 0.26;
const float MOTION_SPEED = 0.74;
