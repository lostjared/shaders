...
// cosmic ferrofluid alloy: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 31.0;
const float HUE_OFFSET = 0.93;
const float WARP_STRENGTH = 1.18;
const float BASE_ROUGHNESS = 0.17;
const float MOTION_SPEED = 0.68;
