...
// fractal rainbow alloy: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 52.0;
const float HUE_OFFSET = 0.81;
const float WARP_STRENGTH = 1.40;
const float BASE_ROUGHNESS = 0.24;
const float MOTION_SPEED = 0.92;
