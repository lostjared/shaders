...
// chrome interference bloom: high-detail rainbow metal with audio-reactive physical lighting.
...
const int STYLE = 0;
const float ARMS = 14.0;
const float DENSITY = 36.0;
const float HUE_OFFSET = 0.34;
const float WARP_STRENGTH = 0.95;
const float BASE_ROUGHNESS = 0.09;
const float MOTION_SPEED = 0.84;
