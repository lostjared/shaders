...
// iridescent multi-source ripples: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 56.0;
const float HUE_OFFSET = 0.07;
const float WARP_STRENGTH = 1.65;
const float BASE_ROUGHNESS = 0.14;
const float MOTION_SPEED = 1.42;
