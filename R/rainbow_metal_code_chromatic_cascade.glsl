...
// chromatic liquid cascade: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 60.0;
const float HUE_OFFSET = 0.48;
const float WARP_STRENGTH = 1.68;
const float BASE_ROUGHNESS = 0.23;
const float MOTION_SPEED = 1.12;
