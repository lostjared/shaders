...
// plasma facet chalice: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 46.0;
const float HUE_OFFSET = 0.18;
const float WARP_STRENGTH = 1.32;
const float BASE_ROUGHNESS = 0.19;
const float MOTION_SPEED = 1.08;
