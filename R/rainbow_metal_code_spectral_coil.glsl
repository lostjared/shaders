...
// spectrum-wrapped metal coil: high-detail rainbow metal with audio-reactive physical lighting.
...
const float HUE_OFFSET = 0.46;
const float WARP_STRENGTH = 1.45;
const float BASE_ROUGHNESS = 0.18;
const float MOTION_SPEED = 1.28;
