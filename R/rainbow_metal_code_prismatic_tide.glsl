...
// layered prismatic tide pools: high-detail rainbow metal with audio-reactive physical lighting.
...
const int STYLE = 0;
const float ARMS = 8.0;
const float DENSITY = 28.0;
const float HUE_OFFSET = 0.02;
const float WARP_STRENGTH = 1.10;
const float BASE_ROUGHNESS = 0.16;
const float MOTION_SPEED = 1.00;
