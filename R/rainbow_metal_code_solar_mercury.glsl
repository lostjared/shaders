...
// solar mercury shockwaves: high-detail rainbow metal with audio-reactive physical lighting.
...
const float HUE_OFFSET = 0.52;
const float WARP_STRENGTH = 1.50;
const float BASE_ROUGHNESS = 0.12;
const float MOTION_SPEED = 1.30;
