...
// infinite mercury coils: high-detail rainbow metal with audio-reactive physical lighting.
...
const int STYLE = 1;
const float ARMS = 24.0;
const float DENSITY = 66.0;
const float HUE_OFFSET = 0.59;
const float WARP_STRENGTH = 1.76;
const float BASE_ROUGHNESS = 0.09;
const float MOTION_SPEED = 1.58;
