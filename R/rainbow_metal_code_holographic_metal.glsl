...
// holographic spiral metal: high-detail rainbow metal with audio-reactive physical lighting.
...
const int STYLE = 1;
const float ARMS = 18.0;
const float DENSITY = 40.0;
const float HUE_OFFSET = 0.75;
const float WARP_STRENGTH = 1.22;
const float BASE_ROUGHNESS = 0.08;
const float MOTION_SPEED = 1.02;
