...
// aurora-lit flowing foundry: high-detail rainbow metal with audio-reactive physical lighting.
...
const float DENSITY = 34.0;
const float HUE_OFFSET = 0.11;
const float WARP_STRENGTH = 1.25;
const float BASE_ROUGHNESS = 0.22;
const float MOTION_SPEED = 0.72;
