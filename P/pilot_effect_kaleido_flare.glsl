#version 330 core
// pilot_effect_kaleido_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: af_scale_spectrum.glsl
// Random donor shader: plasma3.glsl
...
const int FAMILY = 2;
const float SEED_A = 7.5900;
const float SEED_B = 11.3700;
const float SEED_C = 5.8100;
const vec3 BASE_TINT = vec3(0.9500, 0.8750, 0.7925);
const float INSP_1 = 0.5347;
const float INSP_2 = 0.6637;
const float INSP_3 = 0.3324;
const float INSP_MODE = 1.0000;
const int CAT_ID = 5;
const int VAR_ID = 2;
const float CAT_SPIN = 0.5455;
const float CAT_WARP = 0.2727;
const float CAT_SAT = 0.7500;
const float VAR_PULSE = 0.3778;
const float VAR_GRID = 0.6188;
const float VAR_STYLE = 0.5122;
const float DONOR_A = 0.2642;
const float DONOR_B = 0.0250;
const float DONOR_C = 0.2482;
const float DONOR_D = 0.0488;
const float DONOR_MODE = 0.1333;
