#version 330 core
// pilot_effect_ant_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: 8bit.glsl
// Random donor shader: mirror-comb-mouse.glsl
...
const int FAMILY = 9;
const float SEED_A = 1.3500;
const float SEED_B = 2.2500;
const float SEED_C = 2.4500;
const vec3 BASE_TINT = vec3(0.8140, 0.9450, 0.8145);
const float INSP_1 = 0.1544;
const float INSP_2 = 0.5621;
const float INSP_3 = 0.8504;
...
const float VAR_GRID = 0.1144;
const float VAR_STYLE = 0.3021;
const float DONOR_A = 0.0772;
const float DONOR_B = 0.0279;
const float DONOR_C = 0.2277;
const float DONOR_D = 0.2171;
