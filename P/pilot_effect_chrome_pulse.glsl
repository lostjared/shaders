#version 330 core
// pilot_effect_chrome_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: DispersionX_Audio.glsl
// Random donor shader: crystalblend2.glsl
...
const int FAMILY = 2;
const float SEED_A = 2.6500;
const float SEED_B = 4.1500;
const float SEED_C = 3.1500;
const vec3 BASE_TINT = vec3(0.8740, 0.8950, 0.9745);
const float INSP_1 = 0.3187;
const float INSP_2 = 0.9081;
const float INSP_3 = 0.2639;
...
const float VAR_GRID = 0.0968;
const float VAR_STYLE = 0.4780;
const float DONOR_A = 0.0536;
const float DONOR_B = 0.3484;
const float DONOR_C = 0.1571;
const float DONOR_D = 0.3894;
