#version 330 core
// pilot_effect_prism_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_ember.glsl
// Random donor shader: snake.glsl
...
const int FAMILY = 1;
const float SEED_A = 11.7500;
const float SEED_B = 17.4500;
const float SEED_C = 8.0500;
const vec3 BASE_TINT = vec3(0.9740, 0.8750, 0.8545);
const float INSP_1 = 0.9159;
const float INSP_2 = 0.9433;
const float INSP_3 = 0.9697;
...
const float VAR_GRID = 0.3333;
const float VAR_STYLE = 0.7781;
const float DONOR_A = 0.0967;
const float DONOR_B = 0.3432;
const float DONOR_C = 0.1547;
const float DONOR_D = 0.3425;
