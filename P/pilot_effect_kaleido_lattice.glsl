#version 330 core
// pilot_effect_kaleido_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: air-bowl.glsl
// Random donor shader: XorKern.glsl
...
const int FAMILY = 5;
const float SEED_A = 7.7200;
const float SEED_B = 11.5600;
const float SEED_C = 5.8800;
const vec3 BASE_TINT = vec3(0.9620, 0.8850, 0.8035);
const float INSP_1 = 0.4985;
const float INSP_2 = 0.6960;
const float INSP_3 = 0.0225;
...
const float VAR_GRID = 0.7214;
const float VAR_STYLE = 0.5171;
const float DONOR_A = 0.3332;
const float DONOR_B = 0.0977;
const float DONOR_C = 0.4126;
const float DONOR_D = 0.0889;
