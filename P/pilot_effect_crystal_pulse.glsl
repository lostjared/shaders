#version 330 core
// pilot_effect_crystal_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Light_Rainbow_Swirl.glsl
// Random donor shader: new_fractal2.glsl
...
const int FAMILY = 7;
const float SEED_A = 3.9500;
const float SEED_B = 6.0500;
const float SEED_C = 3.8500;
const vec3 BASE_TINT = vec3(0.8940, 0.9550, 0.9945);
const float INSP_1 = 0.1388;
const float INSP_2 = 0.9687;
const float INSP_3 = 0.4203;
...
const float VAR_GRID = 0.1378;
const float VAR_STYLE = 0.7977;
const float DONOR_A = 0.1905;
const float DONOR_B = 0.1248;
const float DONOR_C = 0.2474;
const float DONOR_D = 0.2522;
const float DONOR_MODE = 0.4000;
