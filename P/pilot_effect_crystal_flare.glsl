#version 330 core
// pilot_effect_crystal_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: HyperFocusTrails.glsl
// Random donor shader: CursorMove.glsl
...
const int FAMILY = 11;
const float SEED_A = 3.6900;
const float SEED_B = 5.6700;
const float SEED_C = 3.7100;
const vec3 BASE_TINT = vec3(0.8700, 0.9350, 0.9725);
const float INSP_1 = 0.4096;
const float INSP_2 = 0.5415;
const float INSP_3 = 0.5924;
...
const float VAR_GRID = 0.8573;
const float VAR_STYLE = 0.8661;
const float DONOR_A = 0.2889;
const float DONOR_B = 0.1337;
const float DONOR_C = 0.0704;
const float DONOR_D = 0.0345;
