#version 330 core
// pilot_effect_neon_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_liquid_mirror.glsl
// Random donor shader: inflate-ripple.glsl
...
const int FAMILY = 2;
const float SEED_A = 10.8400;
const float SEED_B = 16.1200;
const float SEED_C = 7.5600;
const vec3 BASE_TINT = vec3(0.8500, 0.9450, 1.0000);
const float INSP_1 = 0.1447;
const float INSP_2 = 0.4848;
const float INSP_3 = 0.3392;
const float INSP_MODE = 1.0000;
const int CAT_ID = 7;
const int VAR_ID = 7;
const float CAT_SPIN = 0.7273;
const float CAT_WARP = 0.7273;
const float CAT_SAT = 0.5500;
const float VAR_PULSE = 0.8222;
const float VAR_GRID = 0.6960;
const float VAR_STYLE = 0.5337;
const float DONOR_A = 0.0533;
const float DONOR_B = 0.0593;
const float DONOR_C = 0.0564;
const float DONOR_D = 0.3458;
