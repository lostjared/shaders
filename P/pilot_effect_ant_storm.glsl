...
const int FAMILY = 3;
const float SEED_A = 1.7400;
const float SEED_B = 2.8200;
const float SEED_C = 2.6600;
const vec3 BASE_TINT = vec3(0.8500, 0.9750, 0.8475);
const float INSP_1 = 0.0557;
const float INSP_2 = 0.5718;
const float INSP_3 = 0.7849;
...
const float VAR_GRID = 0.2649;
const float VAR_STYLE = 0.2473;
const float DONOR_A = 0.0212;
const float DONOR_B = 0.0484;
const float DONOR_C = 0.3283;
const float DONOR_D = 0.5245;
