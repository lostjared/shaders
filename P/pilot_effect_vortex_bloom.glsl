#version 330 core
// pilot_effect_vortex_bloom.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_inferno.glsl
// Random donor shader: mirror-zoom.glsl
...
const int FAMILY = 3;
const float SEED_A = 12.5300;
const float SEED_B = 18.5900;
const float SEED_C = 8.4700;
const vec3 BASE_TINT = vec3(0.8060, 0.8350, 0.9305);
const float INSP_1 = 0.7175;
const float INSP_2 = 0.6637;
const float INSP_3 = 0.9658;
...
const float VAR_GRID = 0.9560;
const float VAR_STYLE = 0.3607;
const float DONOR_A = 0.3986;
const float DONOR_B = 0.2259;
const float DONOR_C = 0.1583;
const float DONOR_D = 0.0416;
