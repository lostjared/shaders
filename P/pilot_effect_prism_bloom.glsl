#version 330 core
// pilot_effect_prism_bloom.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_cascade.glsl
// Random donor shader: single-glittch.glsl
...
const int FAMILY = 10;
const float SEED_A = 11.2300;
const float SEED_B = 16.6900;
const float SEED_C = 7.7700;
const vec3 BASE_TINT = vec3(0.9260, 0.8350, 0.8105);
const float INSP_1 = 0.9374;
const float INSP_2 = 0.4985;
const float INSP_3 = 0.0196;
...
const float VAR_GRID = 0.9052;
const float VAR_STYLE = 0.4154;
const float DONOR_A = 0.4085;
const float DONOR_B = 0.2663;
const float DONOR_C = 0.3406;
const float DONOR_D = 0.3657;
