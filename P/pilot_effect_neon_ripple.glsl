#version 330 core
// pilot_effect_neon_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_hypno_lens.glsl
// Random donor shader: material_strobe.glsl
...
const int FAMILY = 1;
const float SEED_A = 10.5800;
const float SEED_B = 15.7400;
const float SEED_C = 7.4200;
const vec3 BASE_TINT = vec3(0.8260, 0.9250, 1.0000);
const float INSP_1 = 0.7498;
const float INSP_2 = 0.2317;
const float INSP_3 = 0.5934;
...
const float VAR_GRID = 0.3148;
const float VAR_STYLE = 0.4946;
const float DONOR_A = 0.0376;
const float DONOR_B = 0.2169;
const float DONOR_C = 0.3873;
const float DONOR_D = 0.5162;
