#version 330 core
// pilot_effect_chrome_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: DispersionY.glsl
// Random donor shader: purple_strobe.glsl
...
const int FAMILY = 7;
const float SEED_A = 2.7800;
const float SEED_B = 4.3400;
const float SEED_C = 3.2200;
const vec3 BASE_TINT = vec3(0.8860, 0.9050, 0.9855);
const float INSP_1 = 0.9355;
const float INSP_2 = 0.6891;
const float INSP_3 = 0.3333;
...
const float VAR_GRID = 0.7654;
const float VAR_STYLE = 0.0743;
const float DONOR_A = 0.1155;
const float DONOR_B = 0.3373;
const float DONOR_C = 0.2571;
const float DONOR_D = 0.0254;
