#version 330 core
// pilot_effect_chrome_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Electric_Fold_Texture.glsl
// Random donor shader: bowl-by_time.glsl
...
const int FAMILY = 4;
const float SEED_A = 3.3000;
const float SEED_B = 5.1000;
const float SEED_C = 3.5000;
const vec3 BASE_TINT = vec3(0.9340, 0.9450, 1.0000);
const float INSP_1 = 0.4497;
const float INSP_2 = 0.4526;
const float INSP_3 = 0.0665;
...
const float VAR_GRID = 0.7791;
const float VAR_STYLE = 0.4233;
const float DONOR_A = 0.2547;
const float DONOR_B = 0.4081;
const float DONOR_C = 0.2904;
const float DONOR_D = 0.5281;
