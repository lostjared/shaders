#version 330 core
// pilot_effect_vortex_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_opal.glsl
// Random donor shader: frac_shader_diamond.glsl
...
const int FAMILY = 1;
const float SEED_A = 12.9200;
const float SEED_B = 19.1600;
const float SEED_C = 8.6800;
const vec3 BASE_TINT = vec3(0.8420, 0.8650, 0.9635);
const float INSP_1 = 0.4985;
const float INSP_2 = 0.1848;
const float INSP_3 = 0.8895;
...
const float VAR_GRID = 0.9550;
const float VAR_STYLE = 0.5738;
const float DONOR_A = 0.2583;
const float DONOR_B = 0.3715;
const float DONOR_C = 0.1458;
const float DONOR_D = 0.1368;
