#version 330 core
// pilot_effect_kaleido_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: air_mouse.glsl
// Random donor shader: time_frac_xor.glsl
...
const int FAMILY = 4;
const float SEED_A = 8.2400;
const float SEED_B = 12.3200;
const float SEED_C = 6.1600;
const vec3 BASE_TINT = vec3(1.0000, 0.9250, 0.8475);
const float INSP_1 = 0.0978;
const float INSP_2 = 0.5982;
const float INSP_3 = 0.8309;
...
const float VAR_GRID = 0.2219;
const float VAR_STYLE = 0.8778;
const float DONOR_A = 0.3883;
const float DONOR_B = 0.1074;
const float DONOR_C = 0.0288;
const float DONOR_D = 0.5248;
