#version 330 core
// pilot_effect_fractal_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Rainbow_Wave.glsl
// Random donor shader: diagsquarecircle.glsl
...
const int FAMILY = 5;
const float SEED_A = 5.3800;
const float SEED_B = 8.1400;
const float SEED_C = 4.6200;
const vec3 BASE_TINT = vec3(0.9560, 0.8250, 0.9855);
const float INSP_1 = 0.1163;
const float INSP_2 = 0.0733;
const float INSP_3 = 0.3959;
...
const float VAR_GRID = 0.7067;
const float VAR_STYLE = 0.7351;
const float DONOR_A = 0.3659;
const float DONOR_B = 0.2338;
const float DONOR_C = 0.3527;
const float DONOR_D = 0.3550;
