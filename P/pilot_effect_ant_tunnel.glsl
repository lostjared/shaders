#version 330 core
// pilot_effect_ant_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: CursorWarp2.glsl
// Random donor shader: ant_spectrum_echo_chamber.glsl
...
const int FAMILY = 7;
const float SEED_A = 1.8700;
const float SEED_B = 3.0100;
const float SEED_C = 2.7300;
const vec3 BASE_TINT = vec3(0.8620, 0.9850, 0.8585);
const float INSP_1 = 0.4927;
const float INSP_2 = 0.3480;
const float INSP_3 = 0.6999;
...
const float VAR_GRID = 0.2287;
const float VAR_STYLE = 0.5513;
const float DONOR_A = 0.2856;
const float DONOR_B = 0.0412;
const float DONOR_C = 0.0700;
const float DONOR_D = 0.5573;
