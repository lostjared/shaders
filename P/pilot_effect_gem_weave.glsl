#version 330 core
// pilot_effect_gem_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: af_scale2.glsl
// Random donor shader: fractal_mirror_ripple_fold.glsl
...
const int FAMILY = 7;
const float SEED_A = 7.2000;
const float SEED_B = 10.8000;
const float SEED_C = 5.6000;
const vec3 BASE_TINT = vec3(0.9140, 0.9950, 0.9495);
const float INSP_1 = 0.7009;
const float INSP_2 = 0.7390;
const float INSP_3 = 0.8788;
...
const float VAR_GRID = 0.1124;
const float VAR_STYLE = 0.9746;
const float DONOR_A = 0.1911;
const float DONOR_B = 0.0499;
const float DONOR_C = 0.1178;
const float DONOR_D = 0.0410;
