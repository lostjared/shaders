#version 330 core
// pilot_effect_mirror_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_crystal_pulse.glsl
// Random donor shader: mirror_x_audio28.glsl
...
const int FAMILY = 5;
const float SEED_A = 9.8000;
const float SEED_B = 14.6000;
const float SEED_C = 7.0000;
const vec3 BASE_TINT = vec3(0.9540, 0.9450, 0.9495);
const float INSP_1 = 0.8133;
const float INSP_2 = 0.6510;
const float INSP_3 = 0.6158;
const float INSP_MODE = 0.3333;
const int CAT_ID = 6;
const int VAR_ID = 9;
const float CAT_SPIN = 0.6364;
const float CAT_WARP = 0.9091;
const float CAT_SAT = 0.5000;
const float VAR_PULSE = 1.0000;
const float VAR_GRID = 0.7713;
const float VAR_STYLE = 0.8954;
const float DONOR_A = 0.2265;
const float DONOR_B = 0.1816;
const float DONOR_C = 0.1226;
const float DONOR_D = 0.1910;
const float DONOR_MODE = 0.3333;
