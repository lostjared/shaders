#version 330 core
// pilot_effect_vortex_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_ripple.glsl
// Random donor shader: reverse_alpha.glsl
...
const int FAMILY = 0;
const float SEED_A = 13.4400;
const float SEED_B = 19.9200;
const float SEED_C = 8.9600;
const vec3 BASE_TINT = vec3(0.8900, 0.9050, 1.0000);
const float INSP_1 = 0.2434;
const float INSP_2 = 0.3578;
const float INSP_3 = 0.1760;
...
const float DONOR_A = 0.2828;
const float DONOR_B = 0.0621;
const float DONOR_C = 0.4014;
const float DONOR_D = 0.5159;
