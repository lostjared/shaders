#version 330 core
// pilot_effect_crystal_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Fractal_Tunnel.glsl
// Random donor shader: new_xor_scale_strobe.glsl
...
const int FAMILY = 9;
const float SEED_A = 4.6000;
const float SEED_B = 7.0000;
const float SEED_C = 4.2000;
const vec3 BASE_TINT = vec3(0.9540, 1.0000, 1.0000);
const float INSP_1 = 0.7879;
const float INSP_2 = 0.4731;
const float INSP_3 = 0.2600;
const float INSP_MODE = 0.3333;
const int CAT_ID = 2;
const int VAR_ID = 9;
const float CAT_SPIN = 0.2727;
const float CAT_WARP = 0.9091;
const float CAT_SAT = 0.7500;
const float VAR_PULSE = 1.0000;
const float VAR_GRID = 0.9883;
const float VAR_STYLE = 0.8524;
const float DONOR_A = 0.0720;
const float DONOR_B = 0.2744;
const float DONOR_C = 0.1000;
const float DONOR_D = 0.1845;
const float DONOR_MODE = 0.2667;
