#version 330 core
// pilot_effect_neon_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_mercury_bloom.glsl
// Random donor shader: cwarp.glsl
...
const int FAMILY = 6;
const float SEED_A = 10.9700;
const float SEED_B = 16.3100;
const float SEED_C = 7.6300;
const vec3 BASE_TINT = vec3(0.8620, 0.9550, 1.0000);
const float INSP_1 = 0.8211;
const float INSP_2 = 0.8944;
const float INSP_3 = 0.8573;
...
const float VAR_GRID = 0.1310;
const float VAR_STYLE = 0.3079;
const float DONOR_A = 0.2612;
const float DONOR_B = 0.4029;
const float DONOR_C = 0.3602;
const float DONOR_D = 0.0393;
