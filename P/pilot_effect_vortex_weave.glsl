#version 330 core
// pilot_effect_vortex_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_storm.glsl
// Random donor shader: fractal_texture_no_wrap.glsl
...
const int FAMILY = 8;
const float SEED_A = 13.7000;
const float SEED_B = 20.3000;
const float SEED_C = 9.1000;
const vec3 BASE_TINT = vec3(0.9140, 0.9250, 1.0000);
const float INSP_1 = 0.4878;
const float INSP_2 = 0.0049;
const float INSP_3 = 0.4868;
const float INSP_MODE = 0.3333;
const int CAT_ID = 9;
const int VAR_ID = 9;
const float CAT_SPIN = 0.9091;
const float CAT_WARP = 0.9091;
const float CAT_SAT = 0.4500;
const float VAR_PULSE = 1.0000;
const float VAR_GRID = 0.6012;
const float VAR_STYLE = 0.9032;
const float DONOR_A = 0.3748;
const float DONOR_B = 0.2226;
const float DONOR_C = 0.4199;
const float DONOR_D = 0.3173;
const float DONOR_MODE = 0.4667;
