#version 330 core
// pilot_effect_mirror_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: and_smooth.glsl
// Random donor shader: mirror_x_audio2.glsl
...
const int FAMILY = 3;
const float SEED_A = 9.1500;
const float SEED_B = 13.6500;
const float SEED_C = 6.6500;
const vec3 BASE_TINT = vec3(0.8940, 0.8950, 0.8945);
const float INSP_1 = 0.8622;
const float INSP_2 = 0.3998;
const float INSP_3 = 0.1153;
...
const float VAR_GRID = 0.1046;
const float VAR_STYLE = 0.9501;
const float DONOR_A = 0.2234;
const float DONOR_B = 0.0663;
const float DONOR_C = 0.0777;
const float DONOR_D = 0.1906;
