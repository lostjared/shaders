...
const int FAMILY = 9;
const float SEED_A = 6.2900;
const float SEED_B = 9.4700;
const float SEED_C = 5.1100;
const vec3 BASE_TINT = vec3(0.8300, 0.9250, 0.8725);
const float INSP_1 = 0.5308;
const float INSP_2 = 0.4448;
const float INSP_3 = 0.9247;
...
const float VAR_GRID = 0.2317;
const float VAR_STYLE = 0.9961;
const float DONOR_A = 0.1669;
const float DONOR_B = 0.1597;
const float DONOR_C = 0.1555;
const float DONOR_D = 0.3815;
