#version 330 core
// pilot_effect_prism_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_glacier.glsl
// Random donor shader: mirror-center.glsl
...
const int FAMILY = 11;
const float SEED_A = 12.2700;
const float SEED_B = 18.2100;
const float SEED_C = 8.3300;
const vec3 BASE_TINT = vec3(1.0000, 0.9150, 0.8985);
const float INSP_1 = 0.5474;
const float INSP_2 = 1.0000;
const float INSP_3 = 0.0274;
...
const float VAR_GRID = 0.1320;
const float VAR_STYLE = 0.1427;
const float DONOR_A = 0.3587;
const float DONOR_B = 0.2837;
const float DONOR_C = 0.3502;
const float DONOR_D = 0.5119;
