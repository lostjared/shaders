#version 330 core
// pilot_effect_prism_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_helix.glsl
// Random donor shader: swirl_by_mouse_pos.glsl
...
const int FAMILY = 3;
const float SEED_A = 12.4000;
const float SEED_B = 18.4000;
const float SEED_C = 8.4000;
const vec3 BASE_TINT = vec3(1.0000, 0.9250, 0.9095);
const float INSP_1 = 0.2825;
const float INSP_2 = 0.5249;
const float INSP_3 = 0.0557;
const float INSP_MODE = 0.6667;
const int CAT_ID = 8;
const int VAR_ID = 9;
const float CAT_SPIN = 0.8182;
const float CAT_WARP = 0.9091;
const float CAT_SAT = 0.6500;
const float VAR_PULSE = 1.0000;
const float VAR_GRID = 0.5425;
const float VAR_STYLE = 0.8172;
const float DONOR_A = 0.3534;
const float DONOR_B = 0.1753;
const float DONOR_C = 0.2046;
const float DONOR_D = 0.0309;
const float DONOR_MODE = 0.0667;
