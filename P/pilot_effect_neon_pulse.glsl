#version 330 core
// pilot_effect_neon_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_glass_mandala.glsl
// Random donor shader: singleton-noise.glsl
...
const int FAMILY = 8;
const float SEED_A = 10.4500;
const float SEED_B = 15.5500;
const float SEED_C = 7.3500;
const vec3 BASE_TINT = vec3(0.8140, 0.9150, 0.9945);
const float INSP_1 = 0.9687;
const float INSP_2 = 0.3920;
const float INSP_3 = 0.0890;
const float INSP_MODE = 1.0000;
const int CAT_ID = 7;
const int VAR_ID = 4;
const float CAT_SPIN = 0.7273;
const float CAT_WARP = 0.4545;
const float CAT_SAT = 0.6500;
const float VAR_PULSE = 0.5556;
const float VAR_GRID = 0.9247;
const float VAR_STYLE = 0.9795;
const float DONOR_A = 0.2841;
const float DONOR_B = 0.2245;
const float DONOR_C = 0.3395;
const float DONOR_D = 0.0317;
