#version 330 core
// pilot_effect_fractal_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Temporal.glsl
// Random donor shader: fractal_mirror_neon_stripe.glsl
...
const int FAMILY = 6;
const float SEED_A = 5.6400;
const float SEED_B = 8.5200;
const float SEED_C = 4.7600;
const vec3 BASE_TINT = vec3(0.9800, 0.8450, 1.0000);
const float INSP_1 = 0.4839;
const float INSP_2 = 0.7752;
const float INSP_3 = 0.9570;
const float INSP_MODE = 1.0000;
const int CAT_ID = 3;
const int VAR_ID = 7;
const float CAT_SPIN = 0.3636;
const float CAT_WARP = 0.7273;
const float CAT_SAT = 0.8000;
const float VAR_PULSE = 0.8222;
const float VAR_GRID = 0.6393;
const float VAR_STYLE = 0.4839;
const float DONOR_A = 0.0491;
const float DONOR_B = 0.1403;
const float DONOR_C = 0.1277;
const float DONOR_D = 0.3800;
const float DONOR_MODE = 0.6000;
