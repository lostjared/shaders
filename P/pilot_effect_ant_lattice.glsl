#version 330 core
// pilot_effect_ant_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: 8bit-norm.glsl
// Random donor shader: ant_light_color_psyche_tunnel.glsl
...
const int FAMILY = 4;
const float SEED_A = 1.2200;
const float SEED_B = 2.0600;
const float SEED_C = 2.3800;
const vec3 BASE_TINT = vec3(0.8020, 0.9350, 0.8035);
const float INSP_1 = 0.4086;
const float INSP_2 = 0.3079;
const float INSP_3 = 0.7048;
...
const float VAR_GRID = 0.0450;
const float VAR_STYLE = 0.9609;
const float DONOR_A = 0.1617;
const float DONOR_B = 0.3359;
const float DONOR_C = 0.3316;
const float DONOR_D = 0.5685;
