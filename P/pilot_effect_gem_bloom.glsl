#version 330 core
// pilot_effect_gem_bloom.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: abc.glsl
// Random donor shader: mirror-wrap-rotate-snap.glsl
...
const int FAMILY = 2;
const float SEED_A = 6.0300;
const float SEED_B = 9.0900;
const float SEED_C = 4.9700;
const vec3 BASE_TINT = vec3(0.8060, 0.9050, 0.8505);
const float INSP_1 = 0.1652;
const float INSP_2 = 0.0753;
const float INSP_3 = 0.7967;
...
const float VAR_GRID = 0.4438;
const float VAR_STYLE = 0.2581;
const float DONOR_A = 0.3395;
const float DONOR_B = 0.2981;
const float DONOR_C = 0.2258;
const float DONOR_D = 0.1775;
