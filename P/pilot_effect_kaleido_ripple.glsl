#version 330 core
// pilot_effect_kaleido_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: air_full.glsl
// Random donor shader: warp-ppong-time.glsl
...
const int FAMILY = 3;
const float SEED_A = 7.9800;
const float SEED_B = 11.9400;
const float SEED_C = 6.0200;
const vec3 BASE_TINT = vec3(0.9860, 0.9050, 0.8255);
const float INSP_1 = 0.1251;
const float INSP_2 = 0.6100;
const float INSP_3 = 0.6022;
...
const float VAR_GRID = 0.6256;
const float VAR_STYLE = 0.9980;
const float DONOR_A = 0.4049;
const float DONOR_B = 0.2820;
const float DONOR_C = 0.1109;
const float DONOR_D = 0.3541;
