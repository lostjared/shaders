#version 330 core
// pilot_effect_crystal_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Crystal_Rainbow1.glsl
// Random donor shader: glow.glsl
...
const int FAMILY = 5;
const float SEED_A = 4.4700;
const float SEED_B = 6.8100;
const float SEED_C = 4.1300;
const vec3 BASE_TINT = vec3(0.9420, 0.9950, 1.0000);
const float INSP_1 = 0.9834;
const float INSP_2 = 0.5005;
const float INSP_3 = 0.7429;
const float INSP_MODE = 1.0000;
const int CAT_ID = 2;
const int VAR_ID = 8;
const float CAT_SPIN = 0.2727;
const float CAT_WARP = 0.8182;
const float CAT_SAT = 0.6000;
const float VAR_PULSE = 0.9111;
const float VAR_GRID = 0.7038;
const float VAR_STYLE = 0.2893;
const float DONOR_A = 0.0707;
const float DONOR_B = 0.2721;
const float DONOR_C = 0.0628;
const float DONOR_D = 0.5433;
const float DONOR_MODE = 0.8000;
