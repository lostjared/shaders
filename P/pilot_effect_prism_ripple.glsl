#version 330 core
// pilot_effect_prism_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_flux.glsl
// Random donor shader: grad3.glsl
...
const int FAMILY = 6;
const float SEED_A = 11.8800;
const float SEED_B = 17.6400;
const float SEED_C = 8.1200;
const vec3 BASE_TINT = vec3(0.9860, 0.8850, 0.8655);
const float INSP_1 = 0.8925;
const float INSP_2 = 0.2258;
const float INSP_3 = 0.8211;
...
const float VAR_GRID = 0.3157;
const float VAR_STYLE = 0.0811;
const float DONOR_A = 0.0971;
const float DONOR_B = 0.3811;
const float DONOR_C = 0.2781;
const float DONOR_D = 0.1968;
