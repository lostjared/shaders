#version 330 core
// pilot_effect_gem_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: addup_cos.glsl
// Random donor shader: fisheye_pi.mp4.glsl
...
const int FAMILY = 11;
const float SEED_A = 6.9400;
const float SEED_B = 10.4200;
const float SEED_C = 5.4600;
const vec3 BASE_TINT = vec3(0.8900, 0.9750, 0.9275);
const float INSP_1 = 0.5777;
const float INSP_2 = 0.4712;
const float INSP_3 = 0.0987;
...
const float VAR_GRID = 0.6168;
const float VAR_STYLE = 0.6149;
const float DONOR_A = 0.3646;
const float DONOR_B = 0.1082;
const float DONOR_C = 0.1735;
const float DONOR_D = 0.2021;
