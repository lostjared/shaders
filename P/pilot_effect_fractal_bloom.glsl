...
const int FAMILY = 9;
const float SEED_A = 4.7300;
const float SEED_B = 7.1900;
const float SEED_C = 4.2700;
const vec3 BASE_TINT = vec3(0.8960, 0.7750, 0.9305);
const float INSP_1 = 0.7996;
const float INSP_2 = 0.1017;
const float INSP_3 = 0.0792;
...
const float VAR_GRID = 0.3118;
const float VAR_STYLE = 0.6432;
const float DONOR_A = 0.0827;
const float DONOR_B = 0.1347;
const float DONOR_C = 0.3889;
const float DONOR_D = 0.3462;
