#version 330 core
// pilot_effect_chrome_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Electric_Fold.glsl
// Random donor shader: expand_mul.glsl
...
const int FAMILY = 0;
const float SEED_A = 3.1700;
const float SEED_B = 4.9100;
const float SEED_C = 3.4300;
const vec3 BASE_TINT = vec3(0.9220, 0.9350, 1.0000);
const float INSP_1 = 0.2346;
const float INSP_2 = 0.5533;
const float INSP_3 = 0.7595;
...
const float VAR_GRID = 0.6989;
const float VAR_STYLE = 0.1378;
const float DONOR_A = 0.2849;
const float DONOR_B = 0.2701;
const float DONOR_C = 0.1717;
const float DONOR_D = 0.0103;
