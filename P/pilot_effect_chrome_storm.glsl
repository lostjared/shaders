#version 330 core
// pilot_effect_chrome_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ElectricMirror.glsl
// Random donor shader: ant_light_color_neon_mandala.glsl
...
const int FAMILY = 8;
const float SEED_A = 3.0400;
const float SEED_B = 4.7200;
const float SEED_C = 3.3600;
const vec3 BASE_TINT = vec3(0.9100, 0.9250, 1.0000);
const float INSP_1 = 0.2014;
const float INSP_2 = 0.0469;
const float INSP_3 = 0.8475;
const float INSP_MODE = 0.3333;
const int CAT_ID = 1;
const int VAR_ID = 7;
const float CAT_SPIN = 0.1818;
const float CAT_WARP = 0.7273;
const float CAT_SAT = 0.6500;
const float VAR_PULSE = 0.8222;
const float VAR_GRID = 0.2747;
const float VAR_STYLE = 0.0323;
const float DONOR_A = 0.3261;
const float DONOR_B = 0.2855;
const float DONOR_C = 0.3577;
const float DONOR_D = 0.0580;
const float DONOR_MODE = 0.2000;
