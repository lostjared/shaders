#version 330 core
// pilot_effect_kaleido_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: airshader1.glsl
// Random donor shader: scramble.glsl
...
const int FAMILY = 8;
const float SEED_A = 8.3700;
const float SEED_B = 12.5100;
const float SEED_C = 6.2300;
const vec3 BASE_TINT = vec3(1.0000, 0.9350, 0.8585);
const float INSP_1 = 0.9668;
const float INSP_2 = 0.8397;
const float INSP_3 = 0.6149;
...
const float VAR_GRID = 0.8172;
const float VAR_STYLE = 0.8094;
const float DONOR_A = 0.0358;
const float DONOR_B = 0.3353;
const float DONOR_C = 0.2094;
const float DONOR_D = 0.0097;
