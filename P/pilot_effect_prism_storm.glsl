#version 330 core
// pilot_effect_prism_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_fracture.glsl
// Random donor shader: addup_cos.glsl
...
const int FAMILY = 7;
const float SEED_A = 12.1400;
const float SEED_B = 18.0200;
const float SEED_C = 8.2600;
const vec3 BASE_TINT = vec3(1.0000, 0.9050, 0.8875);
const float INSP_1 = 0.8788;
const float INSP_2 = 0.5552;
const float INSP_3 = 0.3206;
...
const float VAR_GRID = 0.0459;
const float VAR_STYLE = 0.7077;
const float DONOR_A = 0.1870;
const float DONOR_B = 0.0225;
const float DONOR_C = 0.2900;
const float DONOR_D = 0.0170;
