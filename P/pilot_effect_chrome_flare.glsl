#version 330 core
// pilot_effect_chrome_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: DispersionRotate.glsl
// Random donor shader: color_swirl_beautiful.glsl
...
const int FAMILY = 6;
const float SEED_A = 2.3900;
const float SEED_B = 3.7700;
const float SEED_C = 3.0100;
const vec3 BASE_TINT = vec3(0.8500, 0.8750, 0.9525);
const float INSP_1 = 0.7957;
const float INSP_2 = 0.4037;
const float INSP_3 = 0.1310;
...
const float VAR_GRID = 0.8788;
const float VAR_STYLE = 0.4213;
const float DONOR_A = 0.1411;
const float DONOR_B = 0.3331;
const float DONOR_C = 0.3072;
const float DONOR_D = 0.5339;
