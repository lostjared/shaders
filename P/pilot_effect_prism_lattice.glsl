#version 330 core
// pilot_effect_prism_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_crystal.glsl
// Random donor shader: bright.glsl
...
const int FAMILY = 8;
const float SEED_A = 11.6200;
const float SEED_B = 17.2600;
const float SEED_C = 7.9800;
const vec3 BASE_TINT = vec3(0.9620, 0.8650, 0.8435);
const float INSP_1 = 0.7322;
const float INSP_2 = 0.8622;
const float INSP_3 = 0.2004;
...
const float VAR_GRID = 0.8319;
const float VAR_STYLE = 0.4438;
const float DONOR_A = 0.1123;
const float DONOR_B = 0.1200;
const float DONOR_C = 0.1414;
const float DONOR_D = 0.5216;
const float DONOR_MODE = 0.8667;
