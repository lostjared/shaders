#version 330 core
// pilot_effect_vortex_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_prism.glsl
// Random donor shader: ant_light_color_fractal_fire.glsl
...
const int FAMILY = 11;
const float SEED_A = 13.1800;
const float SEED_B = 19.5400;
const float SEED_C = 8.8200;
const vec3 BASE_TINT = vec3(0.8660, 0.8850, 0.9855);
const float INSP_1 = 0.3216;
const float INSP_2 = 0.3646;
const float INSP_3 = 0.6109;
const float INSP_MODE = 0.6667;
const int CAT_ID = 9;
const int VAR_ID = 5;
const float CAT_SPIN = 0.9091;
const float CAT_WARP = 0.5455;
const float CAT_SAT = 0.4000;
const float VAR_PULSE = 0.6444;
const float VAR_GRID = 0.8993;
const float VAR_STYLE = 0.9110;
const float DONOR_A = 0.3850;
const float DONOR_B = 0.2212;
const float DONOR_C = 0.0229;
const float DONOR_D = 0.4048;
const float DONOR_MODE = 0.5333;
