#version 330 core
// pilot_effect_mirror_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: analog.glsl
// Random donor shader: frac_shader02_dmdXi.glsl
...
const int FAMILY = 10;
const float SEED_A = 9.0200;
const float SEED_B = 13.4600;
const float SEED_C = 6.5800;
const vec3 BASE_TINT = vec3(0.8820, 0.8850, 0.8835);
const float INSP_1 = 0.2414;
const float INSP_2 = 0.7204;
const float INSP_3 = 0.1320;
...
const float VAR_GRID = 0.2766;
const float VAR_STYLE = 0.6246;
const float DONOR_A = 0.1619;
const float DONOR_B = 0.2665;
const float DONOR_C = 0.2926;
const float DONOR_D = 0.6148;
