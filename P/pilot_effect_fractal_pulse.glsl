#version 330 core
// pilot_effect_fractal_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Rainbow.glsl
// Random donor shader: material_color_grid.glsl
...
const int FAMILY = 0;
const float SEED_A = 5.2500;
const float SEED_B = 7.9500;
const float SEED_C = 4.5500;
const vec3 BASE_TINT = vec3(0.9440, 0.8150, 0.9745);
const float INSP_1 = 0.9550;
const float INSP_2 = 0.8778;
const float INSP_3 = 0.8974;
...
const float VAR_GRID = 0.9892;
const float VAR_STYLE = 0.0381;
const float DONOR_A = 0.2946;
const float DONOR_B = 0.0135;
const float DONOR_C = 0.1167;
const float DONOR_D = 0.1909;
