#version 330 core
// pilot_effect_vortex_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_orbital.glsl
// Random donor shader: bend_dir.glsl
...
const int FAMILY = 6;
const float SEED_A = 13.0500;
const float SEED_B = 19.3500;
const float SEED_C = 8.7500;
const vec3 BASE_TINT = vec3(0.8540, 0.8750, 0.9745);
const float INSP_1 = 0.4027;
const float INSP_2 = 0.4506;
const float INSP_3 = 0.7419;
...
const float VAR_STYLE = 0.9423;
const float DONOR_A = 0.3229;
const float DONOR_B = 0.3979;
const float DONOR_C = 0.3620;
