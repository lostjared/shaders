#version 330 core
// pilot_effect_crystal_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Censorship.glsl
// Random donor shader: auraXi2.glsl
...
const int FAMILY = 0;
const float SEED_A = 4.0800;
const float SEED_B = 6.2400;
const float SEED_C = 3.9200;
const vec3 BASE_TINT = vec3(0.9060, 0.9650, 1.0000);
const float INSP_1 = 0.9883;
const float INSP_2 = 0.8710;
const float INSP_3 = 0.6354;
...
const float VAR_GRID = 0.7703;
const float VAR_STYLE = 0.4780;
const float DONOR_A = 0.3957;
const float DONOR_B = 0.3400;
const float DONOR_C = 0.2494;
const float DONOR_D = 0.4401;
