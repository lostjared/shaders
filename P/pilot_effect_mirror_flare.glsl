#version 330 core
// pilot_effect_mirror_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: alpha_xor.glsl
// Random donor shader: frac_texture.glsl
...
const int FAMILY = 7;
const float SEED_A = 8.8900;
const float SEED_B = 13.2700;
const float SEED_C = 6.5100;
const vec3 BASE_TINT = vec3(0.8700, 0.8750, 0.8725);
const float INSP_1 = 0.5973;
const float INSP_2 = 0.5670;
const float INSP_3 = 0.3245;
...
const float VAR_GRID = 0.8866;
const float VAR_STYLE = 0.8856;
const float DONOR_A = 0.3302;
const float DONOR_B = 0.1041;
const float DONOR_C = 0.2979;
const float DONOR_D = 0.4871;
