...
const int FAMILY = 0;
const float SEED_A = 6.4200;
const float SEED_B = 9.6600;
const float SEED_C = 5.1800;
const vec3 BASE_TINT = vec3(0.8420, 0.9350, 0.8835);
const float INSP_1 = 0.6129;
const float INSP_2 = 0.8436;
const float INSP_3 = 0.8045;
...
const float VAR_GRID = 0.0235;
const float VAR_STYLE = 0.8954;
const float DONOR_A = 0.1375;
const float DONOR_B = 0.3146;
const float DONOR_C = 0.1054;
const float DONOR_D = 0.5238;
