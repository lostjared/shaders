...
const int FAMILY = 4;
const float SEED_A = 3.4300;
const float SEED_B = 5.2900;
const float SEED_C = 3.5700;
const vec3 BASE_TINT = vec3(0.8460, 0.9150, 0.9505);
const float INSP_1 = 0.6686;
const float INSP_2 = 0.1427;
const float INSP_3 = 0.4066;
...
const float VAR_GRID = 0.5689;
const float VAR_STYLE = 0.3803;
const float DONOR_A = 0.3320;
const float DONOR_B = 0.1575;
const float DONOR_C = 0.1320;
const float DONOR_D = 0.1875;
