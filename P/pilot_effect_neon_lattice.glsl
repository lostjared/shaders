#version 330 core
// pilot_effect_neon_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_fractal_ocean.glsl
// Random donor shader: Dispersion.glsl
...
const int FAMILY = 3;
const float SEED_A = 10.3200;
const float SEED_B = 15.3600;
const float SEED_C = 7.2800;
const vec3 BASE_TINT = vec3(0.8020, 0.9050, 0.9835);
const float INSP_1 = 0.9150;
const float INSP_2 = 0.0430;
const float INSP_3 = 0.4761;
const float INSP_MODE = 1.0000;
const int CAT_ID = 7;
const int VAR_ID = 3;
const float CAT_SPIN = 0.7273;
const float CAT_WARP = 0.3636;
const float CAT_SAT = 0.5000;
const float VAR_PULSE = 0.4667;
const float VAR_GRID = 0.3451;
const float VAR_STYLE = 0.9022;
const float DONOR_A = 0.3841;
const float DONOR_B = 0.2070;
const float DONOR_C = 0.3095;
const float DONOR_D = 0.4415;
const float DONOR_MODE = 0.6667;
