#version 330 core
// pilot_effect_gem_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: acidcolor.glsl
// Random donor shader: mirror-color-mouse.glsl
...
const int FAMILY = 5;
const float SEED_A = 6.5500;
const float SEED_B = 9.8500;
const float SEED_C = 5.2500;
const vec3 BASE_TINT = vec3(0.8540, 0.9450, 0.8945);
const float INSP_1 = 0.4399;
const float INSP_2 = 0.4800;
const float INSP_3 = 0.9091;
...
const float VAR_GRID = 0.7634;
const float VAR_STYLE = 0.9355;
const float DONOR_A = 0.2255;
const float DONOR_B = 0.3852;
const float DONOR_C = 0.1872;
const float DONOR_D = 0.0510;
