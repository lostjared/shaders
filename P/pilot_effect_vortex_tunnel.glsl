#version 330 core
// pilot_effect_vortex_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_shard.glsl
// Random donor shader: bubble-zoom-mouse.glsl
...
const int FAMILY = 4;
const float SEED_A = 13.5700;
const float SEED_B = 20.1100;
const float SEED_C = 9.0300;
const vec3 BASE_TINT = vec3(0.9020, 0.9150, 1.0000);
const float INSP_1 = 0.8563;
const float INSP_2 = 0.1183;
...
const float VAR_GRID = 0.5904;
const float VAR_STYLE = 0.8495;
const float DONOR_A = 0.3304;
const float DONOR_B = 0.3750;
const float DONOR_C = 0.0402;
const float DONOR_D = 0.5289;
