#version 330 core
// pilot_effect_crystal_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: HyperVortex.glsl
// Random donor shader: glitch1.glsl
...
const int FAMILY = 2;
const float SEED_A = 3.8200;
const float SEED_B = 5.8600;
const float SEED_C = 3.7800;
const vec3 BASE_TINT = vec3(0.8820, 0.9450, 0.9835);
const float INSP_1 = 0.4536;
const float INSP_2 = 0.4106;
const float INSP_3 = 0.2766;
...
const float VAR_GRID = 0.4829;
const float VAR_STYLE = 0.0528;
const float DONOR_A = 0.1913;
const float DONOR_B = 0.2196;
const float DONOR_C = 0.2364;
const float DONOR_D = 0.0272;
