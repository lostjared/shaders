#version 330 core
// pilot_effect_mirror_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_chrome_wave.glsl
// Random donor shader: psych_ripple.glsl
...
const int FAMILY = 9;
const float SEED_A = 9.5400;
const float SEED_B = 14.2200;
const float SEED_C = 6.8600;
const vec3 BASE_TINT = vec3(0.9300, 0.9250, 0.9275);
const float INSP_1 = 0.6119;
const float INSP_2 = 0.1799;
const float INSP_3 = 0.7752;
...
const float VAR_GRID = 0.2669;
const float VAR_STYLE = 0.5044;
const float DONOR_A = 0.1018;
const float DONOR_B = 0.2974;
const float DONOR_C = 0.2791;
const float DONOR_D = 0.4059;
