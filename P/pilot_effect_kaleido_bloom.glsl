...
const int FAMILY = 7;
const float SEED_A = 7.3300;
const float SEED_B = 10.9900;
const float SEED_C = 5.6700;
const vec3 BASE_TINT = vec3(0.9260, 0.8550, 0.7705);
const float INSP_1 = 0.3519;
const float INSP_2 = 0.4379;
const float INSP_3 = 0.8035;
...
const float VAR_GRID = 0.8309;
const float VAR_STYLE = 0.2493;
const float DONOR_A = 0.0233;
const float DONOR_B = 0.1956;
const float DONOR_C = 0.1054;
const float DONOR_D = 0.0141;
