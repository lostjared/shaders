#version 330 core
// pilot_effect_fractal_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: XorKern.glsl
// Random donor shader: deepseek4.glsl
...
const int FAMILY = 10;
const float SEED_A = 5.7700;
const float SEED_B = 8.7100;
const float SEED_C = 4.8300;
const vec3 BASE_TINT = vec3(0.9920, 0.8550, 1.0000);
const float INSP_1 = 0.5533;
const float INSP_2 = 0.7605;
const float INSP_3 = 0.5650;
...
const float VAR_GRID = 0.7732;
const float VAR_STYLE = 0.5484;
const float DONOR_A = 0.2399;
const float DONOR_B = 0.3087;
const float DONOR_C = 0.2173;
const float DONOR_D = 0.0599;
