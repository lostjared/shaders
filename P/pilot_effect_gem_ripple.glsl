#version 330 core
// pilot_effect_gem_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: acidcolorrand.glsl
// Random donor shader: prism_quad_by_time.glsl
...
const int FAMILY = 10;
const float SEED_A = 6.6800;
const float SEED_B = 10.0400;
const float SEED_C = 5.3200;
const vec3 BASE_TINT = vec3(0.8660, 0.9550, 0.9055);
const float INSP_1 = 0.9335;
const float INSP_2 = 0.1222;
const float INSP_3 = 0.8338;
const float INSP_MODE = 1.0000;
const int CAT_ID = 4;
const int VAR_ID = 5;
const float CAT_SPIN = 0.4545;
const float CAT_WARP = 0.5455;
const float CAT_SAT = 0.8500;
const float VAR_PULSE = 0.6444;
const float VAR_GRID = 0.5034;
const float VAR_STYLE = 0.7243;
const float DONOR_A = 0.3219;
const float DONOR_B = 0.1704;
const float DONOR_C = 0.2802;
const float DONOR_D = 0.3891;
