#version 330 core
// pilot_effect_neon_bloom.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_deep_bloom.glsl
// Random donor shader: julia.glsl
...
const int FAMILY = 5;
const float SEED_A = 9.9300;
const float SEED_B = 14.7900;
const float SEED_C = 7.0700;
const vec3 BASE_TINT = vec3(0.7660, 0.8750, 0.9505);
const float INSP_1 = 0.8622;
const float INSP_2 = 0.7928;
const float INSP_3 = 0.4262;
...
const float VAR_GRID = 0.3685;
const float VAR_STYLE = 0.3431;
const float DONOR_A = 0.1673;
const float DONOR_B = 0.2033;
const float DONOR_C = 0.1760;
const float DONOR_D = 0.5399;
