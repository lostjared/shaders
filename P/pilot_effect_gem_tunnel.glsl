#version 330 core
// pilot_effect_gem_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: af_scale.glsl
// Random donor shader: frac_shader02_dmd6i_transparent.glsl
...
const int FAMILY = 3;
const float SEED_A = 7.0700;
const float SEED_B = 10.6100;
const float SEED_C = 5.5300;
const vec3 BASE_TINT = vec3(0.9020, 0.9850, 0.9385);
const float INSP_1 = 0.2903;
const float INSP_2 = 0.8338;
const float INSP_3 = 0.3920;
const float INSP_MODE = 0.3333;
const int CAT_ID = 4;
const int VAR_ID = 8;
const float CAT_SPIN = 0.4545;
const float CAT_WARP = 0.8182;
const float CAT_SAT = 0.7500;
const float VAR_PULSE = 0.9111;
const float VAR_GRID = 0.9453;
const float VAR_STYLE = 0.5357;
const float DONOR_A = 0.2760;
const float DONOR_B = 0.1805;
const float DONOR_C = 0.1348;
const float DONOR_D = 0.5166;
