#version 330 core
// pilot_effect_mirror_ripple.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: animation.glsl
// Random donor shader: material_right_in_two.glsl
...
const int FAMILY = 8;
const float SEED_A = 9.2800;
const float SEED_B = 13.8400;
const float SEED_C = 6.7200;
const vec3 BASE_TINT = vec3(0.9060, 0.9050, 0.9055);
const float INSP_1 = 0.7937;
const float INSP_2 = 0.1369;
const float INSP_3 = 0.2630;
...
const float VAR_GRID = 0.9159;
const float VAR_STYLE = 0.7742;
const float DONOR_A = 0.2761;
const float DONOR_B = 0.3873;
const float DONOR_C = 0.1629;
const float DONOR_D = 0.0304;
