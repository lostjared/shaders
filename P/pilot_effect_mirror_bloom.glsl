#version 330 core
// pilot_effect_mirror_bloom.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: alpha_diamond.glsl
// Random donor shader: pastel.glsl
...
const int FAMILY = 0;
const float SEED_A = 8.6300;
const float SEED_B = 12.8900;
const float SEED_C = 6.3700;
const vec3 BASE_TINT = vec3(0.8460, 0.8550, 0.8505);
const float INSP_1 = 0.3871;
const float INSP_2 = 0.9022;
const float INSP_3 = 0.7458;
...
const float VAR_GRID = 0.6569;
const float VAR_STYLE = 0.3685;
const float DONOR_A = 0.2151;
const float DONOR_B = 0.1336;
const float DONOR_C = 0.3255;
const float DONOR_D = 0.5346;
