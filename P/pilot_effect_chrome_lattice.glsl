#version 330 core
// pilot_effect_chrome_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: DispersionX.glsl
// Random donor shader: ant_spectrum_echo_prism.glsl
...
const int FAMILY = 9;
const float SEED_A = 2.5200;
const float SEED_B = 3.9600;
const float SEED_C = 3.0800;
const vec3 BASE_TINT = vec3(0.8620, 0.8850, 0.9635);
const float INSP_1 = 0.0235;
const float INSP_2 = 0.4897;
const float INSP_3 = 0.4692;
...
const float VAR_GRID = 0.6471;
const float VAR_STYLE = 0.1261;
const float DONOR_A = 0.2095;
const float DONOR_B = 0.1071;
const float DONOR_C = 0.3816;
const float DONOR_D = 0.4038;
