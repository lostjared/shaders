#version 330 core
// pilot_effect_vortex_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_nebula.glsl
// Random donor shader: mirror_x_audio40.glsl
...
const int FAMILY = 10;
const float SEED_A = 12.7900;
const float SEED_B = 18.9700;
const float SEED_C = 8.6100;
const vec3 BASE_TINT = vec3(0.8300, 0.8550, 0.9525);
const float INSP_1 = 0.2483;
const float INSP_2 = 0.1349;
const float INSP_3 = 0.5758;
const float INSP_MODE = 1.0000;
const int CAT_ID = 9;
const int VAR_ID = 2;
const float CAT_SPIN = 0.9091;
const float CAT_WARP = 0.2727;
const float CAT_SAT = 0.5000;
const float VAR_PULSE = 0.3778;
const float VAR_GRID = 0.7439;
const float VAR_STYLE = 0.8778;
const float DONOR_A = 0.3592;
const float DONOR_B = 0.0320;
const float DONOR_C = 0.4118;
const float DONOR_D = 0.5448;
const float DONOR_MODE = 1.0000;
