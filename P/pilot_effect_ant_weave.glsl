#version 330 core
// pilot_effect_ant_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: DigitalLight.glsl
// Random donor shader: mirror_x_audio20.glsl
...
const int FAMILY = 11;
const float SEED_A = 2.0000;
const float SEED_B = 3.2000;
const float SEED_C = 2.8000;
const vec3 BASE_TINT = vec3(0.8740, 0.9950, 0.8695);
const float INSP_1 = 0.8113;
const float INSP_2 = 0.1496;
const float INSP_3 = 0.8133;
...
const float VAR_GRID = 0.7615;
const float VAR_STYLE = 0.3568;
const float DONOR_A = 0.1870;
const float DONOR_B = 0.0700;
const float DONOR_C = 0.2304;
const float DONOR_D = 0.3631;
