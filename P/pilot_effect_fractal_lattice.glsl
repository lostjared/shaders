#version 330 core
// pilot_effect_fractal_lattice.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Light_Time.glsl
// Random donor shader: mirror_rev2.glsl
...
const int FAMILY = 7;
const float SEED_A = 5.1200;
const float SEED_B = 7.7600;
const float SEED_C = 4.4800;
const vec3 BASE_TINT = vec3(0.9320, 0.8050, 0.9635);
const float INSP_1 = 0.3685;
const float INSP_2 = 0.3392;
const float INSP_3 = 0.3568;
...
const float VAR_GRID = 0.6491;
const float VAR_STYLE = 0.5865;
const float DONOR_A = 0.3481;
const float DONOR_B = 0.1450;
const float DONOR_C = 0.0542;
const float DONOR_D = 0.0265;
const float DONOR_MODE = 0.0000;
