#version 330 core
// pilot_effect_mirror_tunnel.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_cosmic_web.glsl
// Random donor shader: random_x_audio_sine_fold.glsl
...
const int FAMILY = 1;
const float SEED_A = 9.6700;
const float SEED_B = 14.4100;
const float SEED_C = 6.9300;
const vec3 BASE_TINT = vec3(0.9420, 0.9350, 0.9385);
const float INSP_1 = 0.6461;
const float INSP_2 = 0.3900;
const float INSP_3 = 0.3587;
...
const float VAR_GRID = 0.6070;
const float VAR_STYLE = 0.9629;
const float DONOR_A = 0.2324;
const float DONOR_B = 0.2618;
const float DONOR_C = 0.2992;
const float DONOR_D = 0.1999;
