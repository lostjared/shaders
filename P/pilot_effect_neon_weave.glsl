#version 330 core
// pilot_effect_neon_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_aurora.glsl
// Random donor shader: blue.glsl
...
const int FAMILY = 10;
const float SEED_A = 11.1000;
const float SEED_B = 16.5000;
const float SEED_C = 7.7000;
const vec3 BASE_TINT = vec3(0.8740, 0.9650, 1.0000);
const float INSP_1 = 0.4545;
const float INSP_2 = 0.9277;
const float INSP_3 = 0.6070;
...
const float VAR_GRID = 0.1994;
const float VAR_STYLE = 0.9247;
const float DONOR_A = 0.0377;
const float DONOR_B = 0.0882;
const float DONOR_C = 0.1535;
const float DONOR_D = 0.5253;
