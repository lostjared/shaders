#version 330 core
// pilot_effect_chrome_bloom.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: DigitalLightStorm.glsl
// Random donor shader: frac_shader_xor2.glsl
...
const int FAMILY = 11;
const float SEED_A = 2.1300;
const float SEED_B = 3.3900;
const float SEED_C = 2.8700;
const vec3 BASE_TINT = vec3(0.8260, 0.8550, 0.9305);
const float INSP_1 = 0.3539;
const float INSP_2 = 0.6168;
const float INSP_3 = 0.6706;
...
const float VAR_GRID = 0.6647;
const float VAR_STYLE = 0.8407;
const float DONOR_A = 0.3724;
const float DONOR_B = 0.2774;
const float DONOR_C = 0.3288;
const float DONOR_D = 0.5336;
