#version 330 core
// pilot_effect_prism_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_metal_coil.glsl
// Random donor shader: snake_updown.glsl
...
const int FAMILY = 5;
const float SEED_A = 11.4900;
const float SEED_B = 17.0700;
const float SEED_C = 7.9100;
const vec3 BASE_TINT = vec3(0.9500, 0.8550, 0.8325);
const float INSP_1 = 0.7605;
const float INSP_2 = 0.1505;
const float INSP_3 = 0.1349;
const float INSP_MODE = 0.3333;
const int CAT_ID = 8;
const int VAR_ID = 2;
const float CAT_SPIN = 0.8182;
const float CAT_WARP = 0.2727;
const float CAT_SAT = 0.7000;
const float VAR_PULSE = 0.3778;
const float VAR_GRID = 0.6774;
const float VAR_STYLE = 0.8387;
const float DONOR_A = 0.1335;
const float DONOR_B = 0.2017;
const float DONOR_C = 0.3932;
const float DONOR_D = 0.3427;
const float DONOR_MODE = 0.7333;
