#version 330 core
// pilot_effect_fractal_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Light_Rainbow_Blend.glsl
// Random donor shader: xor_rgb_dark.glsl
...
const int FAMILY = 4;
const float SEED_A = 4.9900;
const float SEED_B = 7.5700;
const float SEED_C = 4.4100;
const vec3 BASE_TINT = vec3(0.9200, 0.7950, 0.9525);
const float INSP_1 = 0.9717;
const float INSP_2 = 0.3773;
const float INSP_3 = 0.0499;
...
const float VAR_GRID = 0.0196;
const float VAR_STYLE = 0.0948;
const float DONOR_A = 0.3618;
const float DONOR_B = 0.1978;
const float DONOR_C = 0.1909;
const float DONOR_D = 0.5557;
