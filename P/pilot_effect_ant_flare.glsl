#version 330 core
// pilot_effect_ant_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: 4rand.glsl
// Random donor shader: material_echo_self.glsl
...
const int FAMILY = 1;
const float SEED_A = 1.0900;
const float SEED_B = 1.8700;
const float SEED_C = 2.3100;
const vec3 BASE_TINT = vec3(0.7900, 0.9250, 0.7925);
const float INSP_1 = 0.1046;
const float INSP_2 = 0.0665;
...
const float VAR_GRID = 0.8964;
const float VAR_STYLE = 0.3627;
const float DONOR_A = 0.2441;
const float DONOR_B = 0.0148;
const float DONOR_C = 0.0542;
const float DONOR_D = 0.0188;
