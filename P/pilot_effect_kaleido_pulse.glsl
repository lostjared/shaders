#version 330 core
// pilot_effect_kaleido_pulse.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: air.glsl
// Random donor shader: rainbow.banding.glsl
...
const int FAMILY = 10;
const float SEED_A = 7.8500;
const float SEED_B = 11.7500;
const float SEED_C = 5.9500;
const vec3 BASE_TINT = vec3(0.9740, 0.8950, 0.8145);
const float INSP_1 = 0.3568;
const float INSP_2 = 0.7937;
const float INSP_3 = 0.8827;
...
const float VAR_GRID = 0.3998;
const float VAR_STYLE = 0.5728;
const float DONOR_A = 0.1495;
const float DONOR_B = 0.3568;
const float DONOR_C = 0.1117;
const float DONOR_D = 0.0203;
