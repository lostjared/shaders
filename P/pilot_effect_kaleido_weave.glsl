#version 330 core
// pilot_effect_kaleido_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: all_colors.glsl
// Random donor shader: mirror-wrap-sphere.glsl
...
const int FAMILY = 0;
const float SEED_A = 8.5000;
const float SEED_B = 12.7000;
const float SEED_C = 6.3000;
const vec3 BASE_TINT = vec3(1.0000, 0.9450, 0.8695);
const float INSP_1 = 0.9726;
const float INSP_2 = 0.2884;
const float INSP_3 = 0.5826;
...
const float VAR_GRID = 0.7263;
const float VAR_STYLE = 0.5181;
const float DONOR_A = 0.3082;
const float DONOR_B = 0.1543;
const float DONOR_C = 0.1565;
const float DONOR_D = 0.1773;
