...
const int FAMILY = 2;
const float SEED_A = 1.4800;
const float SEED_B = 2.4400;
const float SEED_C = 2.5200;
const vec3 BASE_TINT = vec3(0.8260, 0.9550, 0.8255);
const float INSP_1 = 0.6872;
const float INSP_2 = 0.1799;
const float INSP_3 = 0.3509;
...
const float VAR_GRID = 0.2952;
const float VAR_STYLE = 0.7400;
const float DONOR_A = 0.0772;
const float DONOR_B = 0.2330;
const float DONOR_C = 0.3395;
const float DONOR_D = 0.0121;
