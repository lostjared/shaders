#version 330 core
// pilot_effect_neon_flare.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: ant_gem_fire_spoke.glsl
// Random donor shader: fractal-fold-neon.glsl
...
const int FAMILY = 0;
const float SEED_A = 10.1900;
const float SEED_B = 15.1700;
const float SEED_C = 7.2100;
const vec3 BASE_TINT = vec3(0.7900, 0.8950, 0.9725);
const float INSP_1 = 0.1065;
const float INSP_2 = 0.2678;
...
const float VAR_GRID = 0.0802;
const float VAR_STYLE = 0.9189;
const float DONOR_A = 0.3547;
const float DONOR_B = 0.2843;
const float DONOR_C = 0.2567;
const float DONOR_D = 0.0985;
