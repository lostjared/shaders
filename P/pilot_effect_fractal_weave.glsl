#version 330 core
// pilot_effect_fractal_weave.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: XorKernBrighter.glsl
// Random donor shader: Liquid_Rainbow_Wave.glsl
...
const int FAMILY = 2;
const float SEED_A = 5.9000;
const float SEED_B = 8.9000;
const float SEED_C = 4.9000;
const vec3 BASE_TINT = vec3(1.0000, 0.8650, 1.0000);
const float INSP_1 = 0.3460;
const float INSP_2 = 0.7312;
const float INSP_3 = 0.5904;
...
const float VAR_GRID = 0.1349;
const float VAR_STYLE = 0.1241;
const float DONOR_A = 0.0864;
const float DONOR_B = 0.2088;
const float DONOR_C = 0.2536;
const float DONOR_D = 0.6527;
