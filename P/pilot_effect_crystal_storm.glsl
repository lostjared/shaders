#version 330 core
// pilot_effect_crystal_storm.glsl
// Diversified pilot shader: frac/mirror/gem/ant + library-inspired prism/ripple/glitch/VHS/grid behaviors.
// Inspired motif source: Liquid_Crystal_2.glsl
// Random donor shader: ant_light_color_cyber_grid.glsl
...
const int FAMILY = 1;
const float SEED_A = 4.3400;
const float SEED_B = 6.6200;
const float SEED_C = 4.0600;
const vec3 BASE_TINT = vec3(0.9300, 0.9850, 1.0000);
const float INSP_1 = 0.0674;
const float INSP_2 = 0.2336;
const float INSP_3 = 0.9619;
const float INSP_MODE = 0.6667;
const int CAT_ID = 2;
const int VAR_ID = 7;
const float CAT_SPIN = 0.2727;
const float CAT_WARP = 0.7273;
const float CAT_SAT = 0.4500;
const float VAR_PULSE = 0.8222;
const float VAR_GRID = 0.4917;
const float VAR_STYLE = 0.7429;
const float DONOR_A = 0.2763;
const float DONOR_B = 0.3733;
const float DONOR_C = 0.0859;
const float DONOR_D = 0.3946;
